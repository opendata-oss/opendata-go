module github.com/opendata-oss/opendata-go/exporter/opendataexporter
...
require (
	...
	github.com/opendata-oss/opendata-go v0.2.0
...
replace github.com/opendata-oss/opendata-go => ../..
